...
- [ ] **Task B1: Implement Vehicle Model (`src/simulator/vehicle.py`)**
...
- [ ] **Task B2: Implement Traffic Signal Controller (`src/simulator/signal.py`)**
...
- [ ] **Task B3: Implement Traffic Generator (`src/simulator/traffic_generator.py`)**
...
- [ ] **Task B4: Implement Simulation Metrics Tracker (`src/simulator/metrics.py`)**
...
- [ ] **Task B5: Implement 4-Way Intersection Simulation Engine (`src/simulator/intersection.py`)**
...
- [ ] **Task B6: Build Comprehensive Unit Tests & Verify Simulator End-to-End**
